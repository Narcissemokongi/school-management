  ...
  if (absences.length === 0) {
    return (
      <div style={{
        ...
        <CheckCircle size={48} color={success} style={{ marginBottom: 16 }} />
        <p style={{ fontSize: 16, fontWeight: 500 }}>Aucune absence enregistrée.</p>
      </div>
    );
  }
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <span style={{ fontWeight: 600, color: textPrimary }}>{a.date}</span>
                  <span style={{
                    padding: "4px 10px",
                    borderRadius: 12,
                    fontSize: 12,
                ...
                <span style={{
                  ...
                  {estJustifiee ? <CheckCircle size={14} /> : estRejetee ? <XCircle size={14} /> : <AlertTriangle size={14} />}
              ...
              {/* Justificatif */}
              {a.justificatif && (
                <div style={{ marginTop: 8, fontSize: 13, color: textSecondary, display: "flex", alignItems: "center", gap: 6 }}>
                  <FileText size={14} />
      ...
      {justifAbsenceId && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ margin: 0, fontSize: 18, fontWeight: 600, color: textPrimary }}>Justifier l'absence</h3>
            <textarea
              value={justifTexte}
