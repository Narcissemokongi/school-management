...
// Composant d'affichage (fonctionnel) avec thème et animations
function ErrorDisplay({ error, onRetry, onReload }) {
  const { dark } = useTheme();
...
// Composant classe (capture les erreurs) exporté sous le nom ErrorBoundary
